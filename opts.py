...
def parse_opt():
    ...
    parser.add_argument('--input_image_h5', type=str, default='data/processed_image.h5',
    ...
    parser.add_argument('--norm_att_feat', type=int, default=0,#change
    ...
    parser.add_argument('--self_critical_after', type=int, default=100,
                        help='After what epoch do we start finetuning the CNN? (-1 = disable; never finetune, 0 = finetune from start)')#change
    parser.add_argument('--seq_per_img', type=int, default=5, #change
                        help='number of captions to sample for each image during training. Done for efficiency since CNN forward pass is expensive. E.g. coco has 5 sents/image')
    parser.add_argument('--finetune_cnn_after', type=int, default=100,
                        help='After what epoch do we start finetuning the CNN? (-1 = disable; never finetune, 0 = finetune from start)') #change
    # Sample related
    ...
    parser.add_argument('--learning_rate', type=float, default=3e-5,
                        help='learning rate')
    parser.add_argument('--learning_rate_decay_start', type=int, default=0,#change
    ...
    parser.add_argument('--val_images_use', type=int, default=-1,#default=3200
    ...
    parser.add_argument('--checkpoint_path', type=str, default='save/rsicd/',
