...
def main(params):
    ...
    ngram_words, ngram_idxs, ref_len = build_dict(imgs['images'], wtoi, params)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dict_json', default='data/rsicd_talk.json', help='output json file')
    parser.add_argument('--output_pkl', default='data/rsicd-train-idf', help='output pickle file')
